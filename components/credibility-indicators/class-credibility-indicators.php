 ...
 */
class Credibility_Indicators extends \Civil_CMS\Component {
	...
	public static function get_indicators() {
		return [
			'original_reporting' => [
				'label'         => __( 'Original Reporting', 'civil-cms' ),
				'default_value' => __( 'This article contains new, firsthand information uncovered by its reporter(s). This includes directly interviewing sources and research / analysis of primary source documents.', 'civil-cms' ),
			],
			'on_the_ground' => [
				'label'         => __( 'On the Ground', 'civil-cms' ),
				'default_value' => __( 'Indicates that a Newsmaker/Newsmakers was/were physically present to report the article from some/all of the location(s) it concerns.', 'civil-cms' ),
			],
			'sources_cited' => [
				'label'         => __( 'Sources Cited', 'civil-cms' ),
				'default_value' => __( 'As a news piece, this article cites verifiable, third-party sources which have all been thoroughly fact-checked and deemed credible by the Newsroom in accordance with the Civil Constitution.', 'civil-cms' ),
			],
			'subject_specialist' => [
				'label'         => __( 'Subject Specialist', 'civil-cms' ),
				'default_value' => __( 'This Newsmaker has been deemed by this Newsroom as having a specialized knowledge of the subject covered in this article.', 'civil-cms' ),
			],
		];
	}
	...
	public function default_settings() : array {
		return [
			...
			'learn_more_text' => __( 'Learn more about Civil’s Credibility Indicators', 'civil-cms' ),
